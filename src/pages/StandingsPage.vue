<template>
  <div class="animate-fade-in space-y-4">
    ...
    <div class="bg-card rounded-lg border border-border overflow-hidden">
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          <thead>
            <tr class="sport-gradient text-primary-foreground text-left">
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider">#</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider">Команда</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center" title="Сыграно">И</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center" title="Победы">В</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center" title="Поражения">П</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center">Партии</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center" title="Разница партий">+/−</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider hidden sm:table-cell">Форма</th>
              <th scope="col" class="px-3 py-3 font-semibold text-xs tracking-wider text-center font-bold">Очки</th>
              <th scope="col" class="px-3 py-3 w-8"><span class="sr-only">Подробнее</span></th>
            </tr>
          </thead>
          <tbody>
            <tr
              ...
              :class="[
                ...
                'hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent',
                rowHighlight(i + 1),
            ...
            >
              <td
                :class="[
                  'px-3 py-3 font-display font-bold',
              ...
              <td class="px-3 py-3 text-center text-muted-foreground">{{ s.played }}</td>
              <td class="px-3 py-3 text-center text-sport-win font-semibold">{{ s.won }}</td>
              <td class="px-3 py-3 text-center text-sport-loss font-semibold">{{ s.lost }}</td>
              <td class="px-3 py-3 text-center text-muted-foreground">{{ s.setsWon }}-{{ s.setsLost }}</td>
              <td
                :class="[
    ...
    <!-- Season progress -->
    <div class="bg-card rounded-lg border border-border px-4 py-3 space-y-1.5">
